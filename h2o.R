################################################################################
# Deep Learning with H2O Examples
# Matthew Lanham - MWDSI, September 2019
...
# It recognizes that the first line in the csv file has a header row, so it has 
...
# look at all the available settings you can try
?h2o.deeplearning
...
################################################################################
# save the model
setwd("C:\\Users\|Matthew A. Lanham\\Dropbox\\_Conferences\\_Talks this year\\2019 MWDSI (Butler University - Indianapolis, IN)")
